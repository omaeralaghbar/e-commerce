 ...
 ?>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                if($_SERVER['REQUEST_URI'] == "/ecommPHP/public/admin/" || $_SERVER['REQUEST_URI'] == "/ecommPHP/public/admin/index.php")  {
                ...
                if(isset($_GET['publish_comment_id'])){
                    ...
                    include(TEMPLATE_BACK . "/publish_comment.php");
                ...
                if(isset($_GET['draft_comment_id'])){
                    ...
                    include(TEMPLATE_BACK . "/draft_comment.php");
